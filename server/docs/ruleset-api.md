...
- DISTANCE: `min_distance_people_structures_m`, `airport_buffer_km`, `cvfr_lane_half_width_m` (CVFR lane corridor half-width from the centerline; ב'-03 §2.ב default, per-lane exceptions unmodeled — DO-015 escalation 1 / decision log 2026-07-11; read fail-closed by the verdict engine's lane-corridor check)
