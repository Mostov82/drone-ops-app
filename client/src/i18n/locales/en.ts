...
const en = {
  ...
  "map.zones.legend.disclaimer":
    "The symbology above is the app's own and differs from official CAAI charts.",
  "map.zones.legend.family.RESTRICTED": "Restricted Airspace (No-Fly)",
  "map.zones.legend.family.NEEDS_PERMIT": "Permit Required Airspace",
  "map.zones.legend.family.CLEAR": "Advisory / Clear Airspace",
