...
const he = {
  ...
  "map.search.label": "[HE?] חיפוש כתובת / מקום",
  "map.search.placeholder": "[HE?] הזן כתובת או שם מקום (למשל צומת גולני)...",
  "map.search.go": "[HE?] חיפוש",
  "map.search.offline": "[HE?] חיפוש המקומות אינו זמין. בדוק את החיבור לרשת.",
  "map.search.rateLimit": "[HE?] חריגה מקצב החיפוש. אנא המתן שנייה ונסה שוב.",
  "map.search.error": "[HE?] חיפוש המקום נכשל.",
  "map.search.noResults": "[HE?] לא נמצאו מקומות תואמים.",
  "map.search.attribution": "[HE?] חיפוש מבוסס על Nominatim (תורמי OSM)",
  ...
  "map.zones.legend.disclaimer":
    "[HE?] הסימון לעיל הוא ייחודי לאפליקציה ושונה מהסימונים במפות רת\"א הרשמיות.",
  "map.zones.legend.family.RESTRICTED": "[HE?] מרחב אווירי אסור לטיסה",
  "map.zones.legend.family.NEEDS_PERMIT": "[HE?] מרחב אווירי טעון אישור",
  "map.zones.legend.family.CLEAR": "[HE?] מרחב אווירי פנוי / ייעוץ",
  "map.zones.class.AIP_PROHIBITED": "[HE?] אזור אסור (LLP)",
  "map.zones.class.AIP_RESTRICTED": "[HE?] אזור מוגבל (LLR)",
  "map.zones.class.AIP_DANGER": "[HE?] אזור סכנה (LLD)",
  "map.zones.class.LLU_DRONE": "[HE?] אזור טיסות רחפנים (LLU)",
  "map.zones.class.AIRPORT": "[HE?] שטח מוגן שדה תעופה (מנחת)",
  "map.zones.class.CTR": "[HE?] אזור פיקוח טיסה (CTR)",
  "map.zones.class.ATZ": "[HE?] אזור תעבורת שדה תעופה (ATZ)",
  "map.zones.class.CTA": "[HE?] אזור בקרה (CTA)",
  "map.zones.class.NATURE_RESERVE": "[HE?] שמורת טבע (רשות הטבע והגנים)",
  "map.zones.class.CVFR_LANE": "[HE?] נתיב טיסה CVFR",
  "map.zones.class.POPULATED": "[HE?] שטח מאוכלס",
  "map.zones.class.BORDER_SECURITY": "[HE?] אזור אבטחת גבול",
  "map.zones.class.OTHER": "[HE?] אזור אחר",
